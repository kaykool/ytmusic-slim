...
- [Issue 04: Packaging and benchmarks](file:///home/sw/1DEV/gemin/.scratch/ytm-audio-only/issues/04-packaging-and-resource-benchmarks.md): Extension packaged in `extension/` (< 16 KB unzipped) with standard PNG icons and 100% automated regression test pass. Resource benchmark in `.scratch/ytm-audio-only/BENCHMARK_REPORT.md` records 0 decoded frames, 0% GPU video decode engine, ~85% CPU drop, and 48.8°C laptop thermals.
